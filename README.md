...
| `/data/` | All the data generated by me for my experiments. Black-and-white images of size 28×28, featuring simple shapes (circle, square, triangle) at different positions within the image. Divided into different types of data, used for different experiments. |
